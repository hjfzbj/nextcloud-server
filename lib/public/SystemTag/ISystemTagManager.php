...
interface ISystemTagManager {
	 ...
	 * @throws TagEditionForbiddenException if user doesn’t have the right to create a new tag
	 *
	 * @since 9.0.0
	 ...
	 *
	 * @throws TagEditionForbiddenException if user doesn’t have the right to update tags
